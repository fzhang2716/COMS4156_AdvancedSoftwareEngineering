...
CC = g++
CFLAGS = -Wall -I /usr/include/cppconn -I jwt-cpp/include -I /usr/include/jsoncpp -I/usr/include/python3.8 -fprofile-arcs -ftest-coverage
TESTCFLAGS = -std=c++14 -Wall -I"Catch2/single_include" -I /usr/include/jsoncpp -I jwt-cpp/include -fprofile-arcs -ftest-coverage
ANALYZETESTFLAGS = -std=c++14 -Wall -I"Catch2/single_include" -I/usr/include/python3.8 -fprofile-arcs -ftest-coverage
...
utils_test: utils_test.o utils.o
	$(CC) $(TESTCFLAGS) -o utils_test utils_test.o utils.o $(LDFLAGS)
...
clean:
	$(RM) coverage_report.txt main utils_test integration_test analyze_data_test main.o data_management.o utils.o utils_test.o integration_test.o analyze_data.o analyze_data_test.o *.gcda *.gcno *.gcov
